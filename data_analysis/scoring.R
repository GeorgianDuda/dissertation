...
###                            The data set                       ###
#####################################################################
main_dir <- 'C:/Workplace-Disertatie/v2/for_analysis/precalculate'
setwd(main_dir)
main_df <- read_excel('Precalculate_main_long.xlsx')
glimpse(main_df)
...
rio::export(data_masking__ml_scoring, file = 'precalculate__ml_scoring.xlsx')
